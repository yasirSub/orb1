...
import { FaUser, FaEnvelope, FaPhone, FaLock, FaBriefcase } from 'react-icons/fa';
...
export default function WorkerSignup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Validation
      if (!formData.name || !formData.emailOrPhone || !formData.password || !formData.confirmPassword || !formData.specialty) {
      ...
      const userExists = registeredUsers.some(user => user.emailOrPhone === formData.emailOrPhone);
      if (userExists) {
      ...
      // Add worker to registered users
      registeredUsers.push(newWorker);
      localStorage.setItem('registeredUsers', JSON.stringify(registeredUsers));

      // Set current worker session
